...
use app\modules\user\forms\frontend\ProfileUpdateInfo;
...
class ProfileController extends Controller
{
    ...
    {
        $user = $this->findModel();
        $model = new ProfileUpdateInfo($user);

        if ($model->load(Yii::$app->request->post()) && $model->info()) {
            return $this->redirect(['index']);
        } else {
